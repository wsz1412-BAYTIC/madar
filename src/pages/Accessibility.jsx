...
export default function Accessibility() {
  ...
  return (
    <div dir={isRTL ? 'rtl' : 'ltr'} className="min-h-screen bg-[#EFF6FA] text-[#06131F]">
      <PublicNavbar />
        ...
        <div className="max-w-4xl mx-auto text-center">
          <FadeIn>
            <div className="flex justify-center mb-6">
              <AccessibilityIcon className="w-16 h-16 text-[#1B84C4]" />
            </div>
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {commitments.map((item, i) => (
              <FadeIn key={i} delay={i * 0.05}>
                <div className="h-full p-6 rounded-2xl border border-[#06131F]/[0.06] hover:border-[#1B84C4]/30 transition-all">
                  <item.Icon className="w-6 h-6 text-[#1B84C4] mb-3" />
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#EFF6FA]">
        <div className="max-w-4xl mx-auto">
          <FadeIn>
            <div className="p-8 rounded-2xl bg-white border border-[#06131F]/[0.06]">
              <div className="flex items-start gap-4">
                <RefreshCw className="w-6 h-6 text-[#1B84C4] flex-shrink-0 mt-1" />
                <div>
      ...
      <section className="pb-24 px-4 sm:px-6 lg:px-8 bg-[#EFF6FA]">
        <div className="max-w-4xl mx-auto">
          <FadeIn>
            <div className="p-8 rounded-2xl bg-gradient-to-r from-[#1B84C4]/10 to-[#ADDFF1]/10 border border-[#1B84C4]/20 text-center">
              <LifeBuoy className="w-8 h-8 text-[#1B84C4] mx-auto mb-4" />
              <h2 className="font-heading font-bold text-[#06131F] text-xl mb-3">
                {ar ? 'تحتاج مساعدة أو واجهت عائقًا؟' : 'Need help or hit a barrier?'}
              </h2>
              <p className="text-[#06131F]/70 text-sm leading-relaxed mb-6 max-w-xl mx-auto">
                {ar
              ...
              <Link
                to="/contact"
                className="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-gradient-to-r from-[#00548C] to-[#003152] text-white font-medium hover:opacity-90 transition-opacity"
              >

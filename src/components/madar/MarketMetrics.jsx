...
export default function MarketMetrics() {
  ...
  return (
    <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-[#06131F] overflow-hidden border-t border-white/[0.04]">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[#ADDFF1]/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <FadeIn className="text-center mb-14">
          ...
          <p className="text-[#F2F8FC]/40 text-sm sm:text-base max-w-xl mx-auto">
            {lang === 'ar'

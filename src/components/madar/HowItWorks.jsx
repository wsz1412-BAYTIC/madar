...
export default function HowItWorks() {
  ...
  return (
    <section className="relative py-28 px-4 sm:px-6 lg:px-8 bg-[#06131F] overflow-hidden border-t border-white/[0.04]">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[#1B84C4]/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <FadeIn className="text-center mb-16">
          ...
          <p className="text-[#F2F8FC]/40 text-base max-w-xl mx-auto">
            {lang === 'ar'
              ...
              >
                ...
                <div className="relative mx-auto w-[88px] h-[88px] mb-6">
                  <div className="absolute inset-0 rounded-full glass-strong border border-white/[0.08] flex items-center justify-center">
                    <step.icon className="w-6 h-6 text-[#0F6BA8]" />
                  </div>
                  <div className="absolute -top-1 -right-1 w-7 h-7 rounded-full bg-gradient-to-br from-[#00548C] to-[#003152] text-white text-xs font-bold flex items-center justify-center">
                    {i + 1}
                  </div>
                </div>

                <h3 className="font-heading text-lg font-bold text-[#F2F8FC] mb-2 leading-snug">

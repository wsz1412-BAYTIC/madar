...
export default function HowItWorks() {
  ...
  return (
    <section className="bg-[#EEEAE1] py-28 md:py-36">
            ...
            return (
              ...
              >
                ...
                <div className="relative flex flex-col items-center text-center md:items-start md:text-start">
                  <div className="relative w-20 h-20 rounded-full bg-white border border-[#1C1C20]/8 flex items-center justify-center mb-6 shadow-sm">
                  ...
                  <h3 className="font-display text-xl md:text-2xl font-light text-[#1C1C20] mb-3">
                    {step.title}
                  </h3>
                  <p className="text-sm md:text-base text-[#1C1C20]/55 font-body leading-relaxed max-w-xs">
                    {step.desc}
                  </p>
                </div>
              </motion.div>

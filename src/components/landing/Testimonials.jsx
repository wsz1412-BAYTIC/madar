...
export default function Testimonials() {
  ...
  return (
    <section className="bg-[#F5F2EC] py-28 md:py-36">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {TESTIMONIALS.map((tm, i) => (
            <motion.div
              ...
              className="relative bg-white border border-[#1C1C20]/8 rounded-2xl p-8 flex flex-col shadow-sm"
            >
              <Quote
                size={40}
              ...
              <p className="text-base text-[#1C1C20]/75 font-body leading-relaxed flex-1">
                {t[`testimonials.${tm.key}.quote`]}
              </p>

              <div className="mt-6 pt-6 border-t border-[#1C1C20]/8">
                <div className="font-display text-lg font-light text-[#1C1C20]">

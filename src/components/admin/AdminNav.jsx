...
import { 
  ...
  FileText, Menu, X, Shield, MessageSquare, BarChart3, Building2, Inbox, ShieldCheck, Megaphone, ShieldAlert
} from 'lucide-react';
...
export default function AdminNav({ admin }) {
  ...
  const menuItems = [
    ...
    { label: lang === 'ar' ? 'تنبيهات الأمان' : 'Security Alerts', icon: ShieldAlert, href: '/admin/security-alerts' },
